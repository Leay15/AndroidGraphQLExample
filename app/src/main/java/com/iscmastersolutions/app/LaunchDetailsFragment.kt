...
import com.iscmastersolutions.app.databinding.LaunchDetailsFragmentBinding
...
class LaunchDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenResumed {
            ...
            try {
                val response = Apollo(requireContext()).client.query(LaunchDetailsQuery(id = args.launchId)).await()
    ...
    private fun configureButton(isBooked: Boolean) {
        ...
        binding.bookButton.setOnClickListener {
            ...
            lifecycleScope.launchWhenResumed {
                ...
                val response = try {
                    Apollo(requireContext()).client.mutate(mutation).await()
